		...
		<div class="body__container">
				<div class="info">
					...
					<div class="info__description pt-10">
						<span v-html="en.description"></span>
					</div>
				</div>
				<div class="cv">
...
<script>
	...
	export default {
		...
		data(){
			return {
				selectedLanguage: this.getSelectedLanguage || "en_base",
				en: this.$store.state.data.en_base,
      		}
		},
		...
		watch: {
			getSelectedLanguage(newLang) {
				...
				switch(this.selectedLanguage){
					case "en":
						this.en = this.$store.state.data.en_base;
						break;
					case "ja":
						this.en = this.$store.state.data.ja_base;
						break
				}
